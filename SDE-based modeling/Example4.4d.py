from UtilitiesPersonal import plotTimeVsX, makeHistogram
import math, random
...
def plotRuns(X_0, D, S, L, delT, endTime, numRuns):
    ...
    # plt.savefig("Example4.4d.png")
    plt.show()



plotRuns(X_0=0.4, D=1e-4, S=1e-2, L=1, delT=0.1, endTime=240, numRuns=5000)